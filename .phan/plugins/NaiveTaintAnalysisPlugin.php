 ...
 */
class NaiveTaintAnalysisPlugin extends PluginV3 implements PostAnalyzeNodeCapability
{
    /**
    ...
    {
        return NaiveTaintAnalysisVisitor::class;
    }
}
 ...
 */
class NaiveTaintAnalysisVisitor extends PluginAwarePostAnalysisVisitor
{
    /**
...
return new NaiveTaintAnalysisPlugin();